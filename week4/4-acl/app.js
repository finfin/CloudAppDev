...
app.get('/users', user.list); //TODO: ensureadmin
app.get('/users/:name', auth.ensureSelfOrAdmin, user.detail); //TODO: ensureSelfOrAdmin
app.get('/users/:name/edit', auth.ensureSelfOrAdmin, user.editView); //TODO: ensureSelfOrAdmin
app.put('/users/:name', auth.ensureSelfOrAdmin, user.edit); //TODO: ensureSelfOrAdmin
app["delete"]('/users/:name', user.remove); //TODO: ensureadmin
